...
products.forEach(item => {
    a += `
        <div class="card p-3 align-items-center shadow border-0" style="width: 18rem; height: 20rem">
          <img src="${item.img}" class="card-img-top" height='130px' alt="...">
            <div class="card-body">
              <h5 class='fw-bold'>${item.title}</h5>
              <h6>${item.color}</h6>
              <h6 class='fw-bold'>${item.prevPrice}</h6>
